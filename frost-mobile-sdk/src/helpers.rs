...
use crate::{coordinator::{new_signing_package, FrostSigningPackage, Message}, participant::{sign, FrostSignatureShare, FrostSigningCommitments, FrostSigningNonces}, FrostKeyPackage, FrostSecretKeyShare, ParticipantIdentifier};
...
pub (crate) fn round_2(
    ...
    message: Message,
) -> (FrostSigningPackage, HashMap<ParticipantIdentifier, FrostSignatureShare>) {
